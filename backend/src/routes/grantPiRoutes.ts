...
import { createGrantPiBridge, editGrantPiBridge, deleteGrantPiBridge, getGrantPiBridgeById, getGrantPiBridgeList, getEffortReport, getGrantPiBridgeByEmployeeAndGrantId, getGrantPiBridgeListByGrantId } from '../controllers/grantPiController';
...
router.get('/list/effortReport', getEffortReport);
