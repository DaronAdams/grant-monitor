...
exports.deleteGrantEmployeeBridge = exports.editGrantEmployeeBridge = exports.getGrantEmployeeBridgeList = exports.getGrantEmployeeBridgeListByGrantId = exports.getGrantEmployeeBridgeByEmployeeAndGrantId = exports.getGrantEmployeeBridgeById = exports.createGrantEmployeeBridge = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
function createGrantEmployeeBridge(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { rate, effort, startDate, endDate, grantId, employeeId, } = req.body;
            ...
            const newGrantEmployeeBridge = yield prisma.grantEmployeeBridge.create({
                data: {
                    rate,
                    effort,
                    startDate,
...
exports.createGrantEmployeeBridge = createGrantEmployeeBridge;
function getGrantEmployeeBridgeById(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const grantEmployeeBridge = yield prisma.grantEmployeeBridge.findUnique({
                where: {
...
exports.getGrantEmployeeBridgeById = getGrantEmployeeBridgeById;
function getGrantEmployeeBridgeByEmployeeAndGrantId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const grantEmployeeBridge = yield prisma.grantEmployeeBridge.findFirst({
                where: {
...
exports.getGrantEmployeeBridgeByEmployeeAndGrantId = getGrantEmployeeBridgeByEmployeeAndGrantId;
function getGrantEmployeeBridgeListByGrantId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const grantEmployeeBridge = yield prisma.grantEmployeeBridge.findMany({
                where: {
                    grantId: grantId,
                },
            });
...
exports.getGrantEmployeeBridgeListByGrantId = getGrantEmployeeBridgeListByGrantId;
function getGrantEmployeeBridgeList(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const grantEmployeeBridges = yield prisma.grantEmployeeBridge.findMany({});
...
exports.getGrantEmployeeBridgeList = getGrantEmployeeBridgeList;
function editGrantEmployeeBridge(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Extract the grantEmployeeBridge ID from the request parameters
            const grantEmployeeBridgeId = parseInt(req.params.id);
            ...
            const updatedGrantEmployeeBridge = yield prisma.grantEmployeeBridge.update({
                where: {
                    id: grantEmployeeBridgeId,
                },
                data: {
...
exports.editGrantEmployeeBridge = editGrantEmployeeBridge;
function deleteGrantEmployeeBridge(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Extract the grantEmployeeBridge ID from the request parameters
            const grantEmployeeBridgeId = parseInt(req.params.id);
            ...
            const deletedGrantEmployeeBridge = yield prisma.grantEmployeeBridge.delete({
                where: {
                    id: grantEmployeeBridgeId,
                },
            });
...
exports.deleteGrantEmployeeBridge = deleteGrantEmployeeBridge;
